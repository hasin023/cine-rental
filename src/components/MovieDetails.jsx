                ...
                >
                    ...
                    <div className="p-5 lg:p-11">
                        <div className="">
                            ...
                            <span
                                className="block text-base text-[#9fa0a4] dark:text-[#575A6E] my-3 mt-4">{movie.genre}</span>
                            <div></div>
                        </div>
                        <p className="text-sm lg:text-base mb-8 lg:mb-16 mt-6">
                            {movie.description}
                        </p>
                        <div className="grid lg:grid-cols-2 gap-2">
                            ...
                            <a
                                className="border border-[#74766F] rounded-lg py-2 px-5 mt-8 flex items-center justify-center gap-2 text-[#6F6F6F] dark:text-gray-200 font-semibold text-sm"
                                href="#"
                                onClick={onClose}
                            >
                                Cancel
